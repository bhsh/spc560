 ...
 * @{
 */
#define ADC_MCR_OWREN               (1UL << 31)
#define ADC_MCR_WLSIDE              (1UL << 30)
#define ADC_MCR_MODE                (1UL << 29)
#define ADC_MCR_NSTART              (1UL << 24)
#define ADC_MCR_JTRGEN              (1UL << 22)
#define ADC_MCR_JEDGE               (1UL << 21)
#define ADC_MCR_JSTART              (1UL << 20)
#define ADC_MCR_CTUEN               (1UL << 17)
#define ADC_MCR_ADCLKSEL            (1UL << 8)
#define ADC_MCR_ABORTCHAIN          (1UL << 7)
#define ADC_MCR_ABORT               (1UL << 6)
#define ADC_MCR_ACKO                (1UL << 5)
#define ADC_MCR_PWDN                (1UL << 0)
/** @} */
 ...
 * @{
 */
#define ADC_MSR_NSTART              (1UL << 24)
#define ADC_MSR_JABORT              (1UL << 23)
#define ADC_MSR_JSTART              (1UL << 20)
#define ADC_MSR_CTUSTART            (1UL << 16)
 ...
 * @{
 */
#define ADC_CDR_VALID               (1UL<< 19)
#define ADC_CDR_OVERW               (1UL<< 18)
#define ADC_CDR_RESULT              (1UL<< 16)
 ...
 * @{
 */
#define ADC_THRHLR_THRH(n)          ((uint32_t)(n) << 16U)
#define ADC_THRHLR_THRL(n)          ((uint32_t)(n) << 0U)
/** @} */
 ...
 * @{
 */
#define ADC_CWSEL0_WSEL_CHN(n)      (((n) - 0U) * 4U)
 ...
 * @{
 */
#define ADC_CWENR0_CWEN_CHN(n)      (1UL<< (n))
#define ADC_CWENR1_CWEN_CHN(n)      (1UL<< ((n) - 32U))
#define ADC_CWENR2_CWEN_CHN(n)      (1UL<< ((n) - 64U))
/** @} */
...
#define ADC_WTIMR_MSKWDG8_LOW       (1UL << 16)
#define ADC_WTIMR_MSKWDG8_HIGH      (1UL << 17)
#define ADC_WTIMR_MSKWDG8_BOTH      (3UL<< 16)
#define ADC_WTIMR_MSKWDG9_LOW       (1UL<< 18)
#define ADC_WTIMR_MSKWDG9_HIGH      (1UL<< 19)
#define ADC_WTIMR_MSKWDG9_BOTH      (3UL<< 18)
#define ADC_WTIMR_MSKWDG10_LOW      (1UL<< 20)
#define ADC_WTIMR_MSKWDG10_HIGH     (1UL<< 21)
#define ADC_WTIMR_MSKWDG10_BOTH     (3UL<< 20)
#define ADC_WTIMR_MSKWDG11_LOW      (1UL<< 22)
#define ADC_WTIMR_MSKWDG11_HIGH     (1UL<< 23)
#define ADC_WTIMR_MSKWDG11_BOTH     (3UL<< 22)
#define ADC_WTIMR_MSKWDG12_LOW      (1UL<< 24)
#define ADC_WTIMR_MSKWDG12_HIGH     (1UL<< 25)
#define ADC_WTIMR_MSKWDG12_BOTH     (3UL<< 24)
#define ADC_WTIMR_MSKWDG13_LOW      (1UL<< 26)
#define ADC_WTIMR_MSKWDG13_HIGH     (1UL<< 27)
#define ADC_WTIMR_MSKWDG13_BOTH     (3UL<< 26)
#define ADC_WTIMR_MSKWDG14_LOW      (1UL<< 28)
#define ADC_WTIMR_MSKWDG14_HIGH     (1UL<< 29)
#define ADC_WTIMR_MSKWDG14_BOTH     (3UL<< 28)
#define ADC_WTIMR_MSKWDG15_LOW      (1UL<< 30)
#define ADC_WTIMR_MSKWDG15_HIGH     (1UL<< 31)
#define ADC_WTIMR_MSKWDG15_BOTH     (3UL<< 30)
#endif
/** @} */
...
#if (SPC5_HAS_EDMA == FALSE) && (SPC5_ADC_DMA_MODE != SPC5_ADC_DMA_OFF)
#error "ADC with DMA is not supported on this device, no DMA found"
#endif

#if (SPC5_HAS_ADC0 == FALSE) && (SPC5_ADC_USE_ADC0 == TRUE)
#error "ADC0 not present in the selected device"
#endif

#if (SPC5_HAS_ADC1 == FALSE)  && (SPC5_ADC_USE_ADC1 == TRUE)

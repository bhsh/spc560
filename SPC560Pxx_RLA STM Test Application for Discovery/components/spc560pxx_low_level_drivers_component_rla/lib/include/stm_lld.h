...
#define SPC5_STM0_CH0_IRQ_PRIORITY                 INTC_PSR_ENABLE(INTC_PSR_CORE0,12)
#endif
...
#define SPC5_STM0_CH1_IRQ_PRIORITY                 INTC_PSR_ENABLE(INTC_PSR_CORE0,12)
#endif
...
#define SPC5_STM0_CH2_IRQ_PRIORITY                 INTC_PSR_ENABLE(INTC_PSR_CORE0,12)
#endif
...
#define SPC5_STM0_CH1_CH3_IRQ_PRIORITY             INTC_PSR_ENABLE(INTC_PSR_CORE0,12)
#endif
...
#define SPC5_STM1_CH0_IRQ_PRIORITY                 INTC_PSR_ENABLE(INTC_PSR_CORE0,12)
#endif
...
#define SPC5_STM1_CH1_IRQ_PRIORITY                 INTC_PSR_ENABLE(INTC_PSR_CORE0,12)
#endif
...
#define SPC5_STM1_CH2_IRQ_PRIORITY                 INTC_PSR_ENABLE(INTC_PSR_CORE0,12)
#endif
...
#define SPC5_STM1_CH3_IRQ_PRIORITY                 INTC_PSR_ENABLE(INTC_PSR_CORE0,12)
#endif
...
#define SPC5_STM2_CH0_IRQ_PRIORITY                 INTC_PSR_ENABLE(INTC_PSR_CORE0,12)
#endif
...
#define SPC5_STM2_CH1_IRQ_PRIORITY                 INTC_PSR_ENABLE(INTC_PSR_CORE0,12)
#endif
...
#define SPC5_STM2_CH2_IRQ_PRIORITY                 INTC_PSR_ENABLE(INTC_PSR_CORE0,12)
#endif
...
#define SPC5_STM2_CH3_IRQ_PRIORITY                 INTC_PSR_ENABLE(INTC_PSR_CORE0,12)
#endif
...
struct STMDriver {
  ...
  */
   ...
   */
  const STM_CH_Config *stm_ch_config;
  /**
...
#endif
#if defined (_SPC563Mxx_) || defined (_SPC564Axx_)
...
extern "C" {
  ...
  void     stm_lld_start         (STMDriver *stmd, const STM_CH_Config *config);

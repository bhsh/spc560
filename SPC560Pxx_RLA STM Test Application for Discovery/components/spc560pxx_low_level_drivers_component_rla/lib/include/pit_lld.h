...
#define SPC5_PIT_IRQ_PRIORITY                    INTC_PSR_ENABLE(INTC_PSR_CORE0,4)
#endif
...
#define SPC5_PIT_CH1_IRQ_PRIORITY                INTC_PSR_ENABLE(INTC_PSR_CORE0,12)
#endif
...
#define SPC5_PIT_CH2_IRQ_PRIORITY                INTC_PSR_ENABLE(INTC_PSR_CORE0,12)
#endif
...
#define SPC5_PIT_CH3_IRQ_PRIORITY                INTC_PSR_ENABLE(INTC_PSR_CORE0,12)
#endif
...
#define SPC5_PIT_CH4_IRQ_PRIORITY                INTC_PSR_ENABLE(INTC_PSR_CORE0,12)
#endif
...
#define SPC5_PIT_CH5_IRQ_PRIORITY                INTC_PSR_ENABLE(INTC_PSR_CORE0,12)
#endif
...
#define SPC5_PIT_CH6_IRQ_PRIORITY                INTC_PSR_ENABLE(INTC_PSR_CORE0,12)
#endif
...
#define SPC5_PIT_CH7_IRQ_PRIORITY                INTC_PSR_ENABLE(INTC_PSR_CORE0,12)
#endif
...
struct PITDriver {
   ...
   */
  const PIT_CH_Config *pit_ch_config;
